...
const PLAN_DETAILS: Record<string, PlanDetails> = {
    ...
    growth: {
        ...
        features: ['5 usuários inclusos', '50.000 contatos', 'WhatsApp Business API', 'Chatbot com IA', 'Automações avançadas']
    },
    scale: {
        name: 'Scale',
        monthlyPrice: '997',
        ...
        features: ['10 usuários inclusos', '75.000 contatos', 'WhatsApp + Telefonia VoIP', 'Onboarding ao vivo', 'Suporte prioritário']
    }
};
...
export const CheckoutModal: React.FC<CheckoutModalProps> = ({
    ...
    useEffect(() => {
        if (isOpen) {
            setStep('bridge'); // Always start with bridge on desktop
            ...
            if (!isMobile) {
                trackEvent('bridge_page_viewed', { plan: plan.name });
            }
        } else {
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 md:p-6">
                ...
                <div className="absolute inset-0 z-[220] flex items-center justify-center p-4">
                    ...
                    >
                        ...
                        <p className="text-gray-600 mb-6">
                            Sua vaga no plano {plan.name} está reservada por mais <strong>10 minutos</strong>.
                        </p>
            ...
            {/* Content: Bridge Page OR Checkout Iframe */}
            {step === 'bridge' ? (
                <BridgePage
                    planName={plan.name}
                    price={price}
                ...
                <div
                    className="relative z-[201] bg-white w-full max-w-5xl rounded-2xl overflow-hidden flex flex-col lg:flex-row"
                    style={{
                        maxHeight: '90vh',
                ...
                >
                    ...
                    <div className="bg-deep-black text-white lg:w-[320px] flex-shrink-0 p-6 lg:p-8 flex flex-col">
                        {/* Header */}
                        ...
                        <div className="flex-grow">
                            <h3 className="text-xs uppercase tracking-widest text-gray-400 mb-3 font-mono">
                                Incluso no plano:
                            </h3>
                    ...
                    <div className="flex-grow flex flex-col bg-white min-h-0">
                        {/* Header - Desktop only */}
                        <div className="hidden lg:flex items-center justify-between px-6 py-4 border-b border-gray-100 flex-shrink-0">
                        ...
                        <div className="flex-grow relative overflow-hidden min-h-[400px]">
                            {/* Loading State */}
                            {!iframeLoaded && (
                            ...
                            {/* Iframe with scroll - enhanced permissions for Stripe/payment */}
                            <iframe
                                src={checkoutUrl}
